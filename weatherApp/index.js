...
//     const defaultApiCall = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=e9f03c0935864a1ba58105924231102&q=kolkata&days=7`);
...
//     sunriseTime.innerText = defaultWeatherData.forecast.forecastday[0].astro.sunrise;
//     sunsetTime.innerText = defaultWeatherData.forecast.forecastday[0].astro.sunset;
...
//         forecastCondition[i].innerText = defaultWeatherData.forecast.forecastday[i].day.condition.text;
//         forecastCardTemp[i].innerText = defaultWeatherData.forecast.forecastday[i].day.avgTemp_c;
//         forecastRainData[i].innerText = defaultWeatherData.forecast.forecastday[i].day.daily_chance_of_rain;
//         forecastHumidityData[i].innerText = defaultWeatherData.forecast.forecastday[i].day.avghumidity;
//         forecastCardImage[i].src = defaultWeatherData.forecast.forecastday[i].day.condition.icon;
//     }
...
//     const fetchData = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=e9f03c0935864a1ba58105924231102&q=${inputValue}&days=7`);
